...
public class NetWorkUtil {
    ...
    private NetWorkUtil() {
        throw new UnsupportedOperationException("Net Exception");
    }
    ...
    public static boolean isWifiNetwork(Context context) {
        ConnectivityManager cm = (ConnectivityManager) context
                .getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo nwi = cm.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
    ...
    public static boolean isWirelessNetwork(Context context) {
        ConnectivityManager cm = (ConnectivityManager) context
                .getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo nwi = cm.getNetworkInfo(ConnectivityManager.TYPE_MOBILE);
        return nwi != null && nwi.isConnected();
    }
    ...
    public static boolean isMobileEnabled(Context context) {
        try {
            ...
            return (Boolean) getMobileDataEnabledMethod.invoke(ConnectivityManager.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        // 反射失败，默认关闭
